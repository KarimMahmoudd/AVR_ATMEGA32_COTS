...
//Interrupt IDs
#define	INT_TIMER0_OVF									1
#define	INT_TIMER0_COMP									2
#define INT_TIMER1_OVF									3
#define INT_TIMER1_CAPT									4
#define INT_TIMER1A_COMP								5
#define INT_TIMER1B_COMP								6
#define INT_TIMER2_OVF									7
#define INT_TIMER2_COMP									8
